	...
	const handleSave = async () => {
		...
		if (!googleKey.trim()) {
			toast({
				...
				description: 'Google Places API key is required.',
				variant: 'destructive',
			});
			return;
		}
		...
		try {
			...
			toast({
				...
				description:
					'Your API keys and database configuration have been securely saved.',
			});
	...
	return (
		<Card className='w-full max-w-4xl mx-auto'>
			<CardHeader>
				...
				<CardDescription>
					Configure your API keys for Google and OpenAI services to
					use all features.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<Tabs defaultValue='status' className='w-full'>
					...
					<TabsContent value='setup' className='space-y-4'>
						<Alert>
							...
							<AlertDescription>
								All API keys are required for the application to
								function. Your keys are stored securely and only
								used for your searches. Click "Instructions" for
								setup help.
							</AlertDescription>
						</Alert>
						...
						<div className='space-y-4'>
							...
							<div className='space-y-2'>
								...
								<Input
									...
									placeholder='mongodb+srv://username:password@cluster.mongodb.net/database (required)'
									required
								/>
							</div>
						...
						<div className='space-y-6'>
							<div>
								...
								<div className='space-y-2 text-sm'>
									...
									<p>
										<strong>2. Enable these APIs:</strong>
									</p>
									<ul className='list-disc ml-6 space-y-1'>
										<li>Places API (New)</li>
										<li>
											Places API (Legacy) - for backwards
											compatibility
										</li>
										<li>Geocoding API</li>
									</ul>
									...
									<p>
										<strong>3. Create an API Key:</strong>
									</p>
									<ul className='list-disc ml-6 space-y-1'>
										<li>
											Click "Create Credentials" → "API
											Key"
										</li>
										<li>
											Restrict the key to the APIs listed
											above
										</li>
										<li>
											Set appropriate usage limits to
											control costs
										</li>
									</ul>
									...
									<ul className='list-disc ml-6 space-y-1'>
										<li>
											Places Text Search: $32 per 1,000
											requests
										</li>
										<li>
							...
							<div>
								...
								<div className='space-y-2 text-sm'>
									...
									<ul className='list-disc ml-6 space-y-1'>
										...
										<li>
											Give it a name for this application
										</li>
										<li>
											Copy the key immediately (you won't
											see it again)
										</li>
									</ul>
									...
									<ul className='list-disc ml-6 space-y-1'>
										<li>
											Generating search term suggestions
										</li>
										<li>
											Creating city lists for state-wide
											searches
										</li>
									...
									<ul className='list-disc ml-6 space-y-1'>
										<li>
											GPT-4 usage: ~$0.001 per suggestion
											generation
										</li>
										<li>
											Very low cost compared to Google
											APIs
										</li>
									</ul>
								</div>
							...
							<div>
								...
								<div className='space-y-2 text-sm'>
									...
									<ul className='list-disc ml-6 space-y-1'>
										<li>
											Go to "Database Access" in the left
											sidebar
										</li>
										<li>Click "Add New Database User"</li>
										<li>
											Create a username and strong
											password
										</li>
										<li>
											Grant "Read and write to any
									...
									<ul className='list-disc ml-6 space-y-1'>
										<li>
											Go to "Network Access" in the left
											sidebar
										</li>
